# Elementar implementierter K-Means Algorithmus mit ausfuehrlicher Erklärung
...
class Kmeans:
    ...
    def fit(self, X):
        ...
        for i in range(self.max_iterations):
            ...
            # epsilon bzw. erlaubte Abweichung
    ...
    def compute_centers(self, X):
        # Leeres Array für neue Mittelpunkte (t+1)
...
X, y = make_blobs(n_samples=1000, cluster_std=0.60, random_state=0)
